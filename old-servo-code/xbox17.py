...
# Initialize the servo position and joystick pressed flag
...
try:
    ...
    while True:
        ...
        # Start or stop the servo movement based on the joystick status
        if joystick_pressed:
            set_servo_angle(current_angle)
        else:
            set_servo_angle(90)  # Stop the servo by setting to the center angle
