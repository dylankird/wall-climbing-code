...
try:
    ...
    while True:
        ...
        angle_change = int(axis_value * 45)  # Scale to servo angle change (-45 to 45 degrees)

        if abs(angle_change) > 1:  # Only update the angle if the joystick is significantly tilted
