    ...
    while True:
        for event in pygame.event.get():
            if event.type == pygame.JOYBUTTONDOWN:
                if event.button == 0:  # Adjust button number for right movement
                    button_right_pressed = True
                elif event.button == 1:  # Adjust button number for left movement
                    button_left_pressed = True
                elif event.button == 2:  # Adjust button number for stop
                    button_right_pressed = False
                    button_left_pressed = False
            ...
            if button_right_pressed:
                ...
                # Stop the servo completely (default state)
                set_servo_angle(90)
